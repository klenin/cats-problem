...
use fields qw(
    ...
    imports solutions generators validators formals modules pictures attachments encoding
...
sub clear
{
    ...
    $self->{$_} = [] for qw(imports solutions generators validators formals modules pictures attachments);
}
